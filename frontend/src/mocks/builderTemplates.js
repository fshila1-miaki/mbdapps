...
export const PRO_TEMPLATES = [
  ...
  { id: "pro-sathibd", name: "SathiBD — Matrimony Portal", slug: "sathibd", category: "Subscription Service", apis: ["SMS", "OTP", "Subscription", "CaaS"], description: "Full-featured Bangladesh matrimony portal. OTP-verified registration, SMS interest alerts, CaaS-charged subscription plans, user dashboard.", bullets: ["OTP-verified profiles via BDApps", "SMS interest alerts", "CaaS subscription plans (Free/Gold/Platinum)", "User dashboard with interest management"], icon: "💑", palette: { primary: "#f6af04", accent: "#d99400" }, baseRating: 4.9, appsBuilt: 4200, buildTime: "5 min", routeSlug: "sathibd" },
...
export const ANDROID_TEMPLATES = [
  ...
  { id: "and-sathibd", name: "SathiBD — Matrimony Android", slug: "sathibd", category: "Healthcare", description: "Native matrimony Android app with OTP login, profile browser, SMS interest notifications and CaaS subscription.", bullets: ["OTP-based login", "Profile browser", "SMS interest alerts", "CaaS subscription plans", "BDApps App Store ready"], icon: "💑", palette: { primary: "#f6af04", accent: "#d99400" }, baseRating: 4.9, appsBuilt: 3100, buildTime: "5 min", routeSlug: "sathibd", apis: ["SMS", "OTP", "Subscription", "CaaS"] },
