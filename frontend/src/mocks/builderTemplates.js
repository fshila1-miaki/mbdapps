...
export const PRO_TEMPLATES = [
  ...
  { id: "pro-admin", name: "Service Provider Admin Panel", slug: "service-admin", category: "Admin Dashboard", apis: ["All APIs"], description: "Full control panel for developers to manage all their Orbit services.", bullets: ["Subscriber table", "Broadcast composer", "Keyword manager"], icon: "🛠️", palette: { primary: "#0f172a", accent: "#16a34a" }, baseRating: 4.7, appsBuilt: 2450, buildTime: "4 min" },
